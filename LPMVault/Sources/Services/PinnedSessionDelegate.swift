...
final class PinnedSessionDelegate: BoundedHTTPResponseDelegate, @unchecked Sendable {
	...
	private static let responseSigningKeys: [String: Data] = [
		"vault-2026-09-06": Data([
			0x85, 0x86, 0x22, 0x5f, 0xd3, 0xa6, 0x3b, 0xf6,
			0xd1, 0x95, 0x83, 0xee, 0x8f, 0xb1, 0xac, 0x8a,
			0x8b, 0xd8, 0x5a, 0x4c, 0xf5, 0x6f, 0xe4, 0x12,
			0x00, 0x30, 0x5f, 0xcf, 0x46, 0x1b, 0x96, 0x2a,
		]),
		"vault-2026-09": Data([
